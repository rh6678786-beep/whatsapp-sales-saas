    ...
    <div className="min-h-screen flex font-sans bg-white">
      ...
      <div className="w-full lg:w-[45%] flex items-center justify-center p-8 lg:p-12 relative">
        ...
        >
          ...
          {/* Title */}
          <h1 className="text-3xl font-black text-zinc-900 tracking-tight text-center">Welcome Back</h1>
          <p className="text-sm text-zinc-500 font-medium mt-2 mb-10 text-center">Sign in to your dashboard</p>
